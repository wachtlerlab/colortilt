...
echo "[p] Figure 5"
./ct-load.py "$EXPFILE" | ./ct-filter.py --no-control | ./ct-ana.py -C | ./ct-conv.py abs-shift | ./ct-spread.py --sizerel | ./ct-slope.py --method mean size | ./ct-plot.py --no-legend -S -F "slope28.pdf" -P "$DIR" -U in -W 5.75 -H 5.75 --scale 0.5 2>> log.tmp
