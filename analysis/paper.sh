...
echo "[p] Figure 5"
./ct-load.py "$EXPFILE" | ./ct-filter.py --no-control | ./ct-ana.py -C | ./ct-conv.py abs-shift | ./ct-spread.py --max-spread | ./ct-plot.py --ylim 25 -S -F "maxspread.pdf" -P "$DIR" -U in -W 5.75 -H 5.75 2>> log.tmp
